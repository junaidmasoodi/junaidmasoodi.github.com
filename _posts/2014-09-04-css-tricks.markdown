---
layout: post
title:  "Creating Clouds & Rain using CSS"
date:   2014-09-04 11:09:54
categories: CSS
---
...
##How to?
You know there is very less HTML interaction in it, Create one `<div>` say i created `<div class="rainy"></div>` to play with css around it.

I have used [-prefix-free](http://leaverou.github.io/prefixfree/) to work behind the scenes, adding the current browser’s prefix to any CSS code, only when it’s needed.
